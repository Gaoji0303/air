package com.tiantian.manage.config;
 ...
 * Author:三井寿
 * 代码自动生成器
 * 自动生成entity、dao、service、controller 各层代码
 */
public class AutoCode {
    public static void main(String[] args) {
        ...
        gc.setOutputDir(proPath + "\\manage\\src\\main\\java"); //设置代码生成路径
        gc.setAuthor("科比门徒");
        ...
        dsc.setUrl("jdbc:mysql://120.48.60.226:3306/my_pro?useSSL=false&useUnicode=true&characterEncoding=utf-8&serverTimezone=GMT");
        ...
        pc.setModuleName("manage"); //设置并生成该模块包
        pc.setParent("com.tiantian"); //设置模块存放位置
